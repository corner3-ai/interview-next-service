// Copied from https://github.com/livekit-examples/voice-assistant-frontend/blob/main/components/NoAgentNotification.tsx
...
export function NoAgentNotification(props: NoAgentNotificationProps) {
  ...
  return (
    <>
      {showNotification ? (
        <div className="fixed bottom-0 text-sm  max-w-[90vw] flex items-center gap-4 bg-yellow-200 px-4 py-3 rounded-lg">
          <div>
            {/* Warning Icon */}
            <svg
              width="24"
